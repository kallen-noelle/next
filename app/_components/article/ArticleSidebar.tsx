        ...
        {(siteConfig.social.github || siteConfig.social.email) && (
          <div className="flex justify-center gap-3 mt-4">
            {siteConfig.social.github && (
              <a href={`https://github.com/${siteConfig.social.github}`} target="_blank" rel="noopener" className="text-slate-400 hover:text-indigo-500 transition-colors text-lg font-mono">
            ...
            {siteConfig.social.email && (
              <a href={`mailto:${siteConfig.social.email}`} className="text-slate-400 hover:text-indigo-500 transition-colors">
