...
import { getPublishedList, update } from "@/lib/api/chatter";
...
export default function EditChatterPage(props: { params: Promise<{ id: string }> }) {
  ...
  return (
    <div className="max-w-xl">
      <h1 className="text-2xl font-black text-slate-900 dark:text-white mb-6">Edit Chatter</h1>
      ...
      <div className="flex gap-3 mt-6">
        <button onClick={() => router.push("/admin/chatter")} className="px-4 py-2 text-sm text-slate-400 hover:text-slate-600 transition-colors">← Back</button>
