...
export default function AboutPage() {
  useEffect(() => { document.title = `About | ${siteConfig.title}`; }, []);
  ...
  const hasContact = about["email"] || about["github"] || about["gitee"] || about["qq"];
            ...
            {hasContact && (
              <div className="pt-6 border-t border-slate-200 dark:border-slate-700">
                ...
                <div className="flex flex-wrap gap-2">
                  {about["email"] && (
                    <a href={`mailto:${about["email"]}`} className={linkStyles}>
                      <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" /></svg>
                      {about["email"]}
                    </a>
                  )}
                  {about["github"] && (
                    <a href={about["github"]} target="_blank" rel="noreferrer" className={linkStyles}>
                  ...
                  {about["gitee"] && (
                    <a href={about["gitee"]} target="_blank" rel="noreferrer" className={linkStyles}>
