  ...
  return (
    <div className="flex flex-col gap-6 w-full mt-6">
        ...
        >
          ...
          <div className="flex items-center justify-between mt-6 md:mt-8 relative z-10">
            <div className="flex gap-2 sm:gap-6">
              {[
                { count: 0, label: "Articles", color: "text-indigo-600 dark:text-indigo-400" },
                { count: 0, label: "Projects", color: "text-purple-600 dark:text-purple-400" },
                { count: 0, label: "Photos", color: "text-pink-600 dark:text-pink-400" },
              ].map((stat) => (
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 w-full">
        <Link
          href="/article"
          className="rounded-3xl bg-white/40 dark:bg-slate-800/50 backdrop-blur-md border border-white/40 dark:border-white/10 shadow-xl p-6 transition-all duration-700 hover:scale-[1.02] group"
        >
