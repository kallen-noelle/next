...
export default function Home() {
  ...
  const hasContact = !!(about["email"] || about["github"] || about["gitee"]);
    ...
    <div className="flex flex-col gap-6 w-full mt-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 w-full">
        ...
        >
          <div className="flex items-start justify-between relative z-10">
            <div className="flex items-center gap-4 md:gap-6 w-full">
              <div className="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 rounded-xl md:rounded-2xl bg-gradient-to-tr from-indigo-500 to-purple-500 p-1 shadow-lg flex-shrink-0 transition-transform duration-500 group-hover:rotate-3">
                <img src={assetUrl(siteConfig.avatarUrl)} alt="" className="w-full h-full rounded-lg md:rounded-xl object-cover bg-white" />
              </div>
          ...
          {/* Contact links */}
          {hasContact && (
            <div className="flex items-center gap-1 mt-4 relative z-10" onClick={(e) => e.stopPropagation()}>
              {about["email"] && (
                <Tooltip text="Email">
                  <button onClick={() => { window.location.href = `mailto:${about["email"]}`; }} className="p-1.5 rounded-lg text-slate-400 hover:text-indigo-500 hover:bg-indigo-50 dark:hover:bg-indigo-500/10 transition-colors">
              ...
              {about["github"] && (
                <Tooltip text="GitHub">
                  <button onClick={() => { window.open(about["github"], "_blank", "noreferrer"); }} className="p-1.5 rounded-lg text-slate-400 hover:text-indigo-500 hover:bg-indigo-50 dark:hover:bg-indigo-500/10 transition-colors">
              ...
              {about["gitee"] && (
                <Tooltip text="Gitee">
                  <button onClick={() => { window.open(about["gitee"], "_blank", "noreferrer"); }} className="p-1.5 rounded-lg text-slate-400 hover:text-indigo-500 hover:bg-indigo-50 dark:hover:bg-indigo-500/10 transition-colors">
